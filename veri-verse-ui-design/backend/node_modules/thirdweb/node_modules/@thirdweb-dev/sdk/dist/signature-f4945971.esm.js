...
import { bP as SnapshotInputSchema, bQ as SnapshotEntryWithProofSchema, bR as SnapshotSchema, cv as ContractWrapper, ba as BigNumberSchema, a_ as NATIVE_TOKEN_ADDRESS, cA as AmountSchema, cE as QuantitySchema, bb as BigNumberishSchema, cF as BytesLikeSchema, s as DuplicateLeafsError, be as AddressOrEnsSchema, bd as AddressSchema, cG as BasisPointsSchema } from './index-7cd093be.esm.js';
import { f as fetchCurrencyMetadata, i as isNativeToken, a as fetchCurrencyValue } from './fetchCurrencyValue-4fbf513e.esm.js';
import { n as normalizePriceValue } from './normalizePriceValue-16c19b04.esm.js';
import { MerkleTree } from '@thirdweb-dev/merkletree';
import { S as StartDateSchema, E as EndDateSchema } from './assertEnabled-a49eb975.esm.js';
import { z } from 'zod';
import { N as NFTInputOrUriSchema } from './setErc20Allowance-a51d5ff0.esm.js';
import { v4 } from 'uuid';
